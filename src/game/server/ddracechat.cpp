...
void CGameContext::ConInfo(IConsole::IResult *pResult, void *pUserData)
{
	...
	pSelf->Console()->Print(IConsole::OUTPUT_LEVEL_STANDARD, "chatresp",
		"Source Code: github.com/furo321/ddnet-bombtag");
}
...
void CGameContext::ConLockTeam(IConsole::IResult *pResult, void *pUserData)
{
	...
	int Team = ((CGameControllerBomb *)pSelf->m_pController)->m_Teams.m_Core.Team(pResult->m_ClientID);

	bool Lock = ((CGameControllerBomb *)pSelf->m_pController)->m_Teams.TeamLocked(Team);
	...
	{
		((CGameControllerBomb *)pSelf->m_pController)->m_Teams.SetTeamLock(Team, true);
...
{
	((CGameControllerBomb *)m_pController)->m_Teams.SetTeamLock(Team, false);
	...
	else
	{
		...
		else
		{
			str_format(
				...
				sizeof(aBuf),
				"You are in team %d",
				((CGameControllerBomb *)pSelf->m_pController)->m_Teams.m_Core.Team(pResult->m_ClientID));
			pSelf->Console()->Print(IConsole::OUTPUT_LEVEL_STANDARD, "chatresp",
				aBuf);
		}
	}
